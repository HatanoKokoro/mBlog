	...
	<div class="adminbody">
		...
		<div class="container">
			<div class="adminright">
				<form  class="form-horizontal" id="formMenu" method="post" action="admin/about/modify">
					<div class="row">
						<br />
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input class="form-control col-sm-3" type="text" name="title" id="title" value="${data.title }">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<script id="container" name="content" type="text/plain" style="height:400px;" >${data.content}</script>
							</div>
						</div>
